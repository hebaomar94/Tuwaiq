...
protocol Flyable {
    //incase of varible i need to use get (take a value) and set (give it a value )
    var ableToFly: Bool {
        get
    }
...
// here struct not inherit this called as argument or  application not inherit
...
// Protocol support Mutiple Inhertance
