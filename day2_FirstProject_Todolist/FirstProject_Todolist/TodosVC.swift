...
class TodosVC: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        //resive the Notify from (NewToDoVc)
        
        NotificationCenter.default.addObserver(self, selector: #selector(newTodo), name: NSNotification.Name(rawValue: "NewTooDoAdd"), object: nil)
    ...
    @objc func newTodo(notification: Notification ) {
        
        
        //add task to vc

       //var todo = notification.userInfo? ["addedTodo"] as? Todo
